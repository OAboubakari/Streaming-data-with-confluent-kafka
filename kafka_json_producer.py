...
FILE_PATH = r"C:\Users\PC\Desktop\BIG DATA COURSE FSDS\Kafka Confluent Implementation\cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

API_KEY = 'WRRNU6IYHQJPOH3U'
ENDPOINT_SCHEMA_URL  = 'https://psrc-mw731.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'xqpbjCs7u3ae1p/sV8TLapv6ytiHJlRUp+rX3Xun47xT4OL5Hznc/0TYU+52hpcJ'
BOOTSTRAP_SERVER = 'pkc-ymrq7.us-east-2.aws.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'T77HWT22GTIYMN2D'
SCHEMA_REGISTRY_API_SECRET = 'Xaf2+1dJ0o/YsCtyjJfa4+jl7kjK3vGMjvZfR1K+RhydTod4p7ZMUtZzbHAWfZbJ'
